...
export const FeedContext = createContext({
  ...
  setCtxFeed: (feed: string) => {
    console.log(feed);
  },
  setCtxFeedType: (feedType: string) => {
    console.log(feedType);
  },
  setCtxOwner: (owner: string) => {
    console.log(owner);
  },
  setCtxFeedName: (feedName: string) => {
...
const DefaultLayout = ({ children }: LayoutProps) => {
  const { ctxFeed, ctxFeedType, ctxOwner, ctxFeedName } =
